...
class Settings(object):
    def __init__(self):
        ...
        self.SnakeSpeed:int = 0 ### max speed is 0
        ...
        self.Parents = 50
        self.NetworkLayers = [16,12,4] # output must be 4
        self.initPopType = 'Uniform'
        self.ActivationFunction_hdl = 'LeakyReLu'
        self.ActivationFunction_output = 'ReLu'
        self.SelectionType = ['Roulette','Tour']
        self.CrossoverType = ['SBX']
        self.MutationType = ['Gaussian','Uniform']
        self.mutation_prop = 0.02
